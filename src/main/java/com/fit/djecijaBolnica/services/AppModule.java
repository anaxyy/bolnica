...
public class AppModule {
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(AuthorizingRealm.class, HibernateRealm.class).withId("HibernateRealm");
	}
	...
	public static void addRealms(Configuration<Realm> configuration,
			@InjectService("HibernateRealm") HibernateRealm realm) {
	...
	public static void contributeApplicationDefaults(
		...
		configuration.add(SecuritySymbols.LOGIN_URL, "/login"); // kazemo koja stranica je Login
		configuration.add(SecuritySymbols.SUCCESS_URL, "/index");
		
		// ovo nije bitno sada, samo da se nebi alert error pri pokretanu
		configuration.add(SymbolConstants.HMAC_PASSPHRASE, "bolnica"); 
